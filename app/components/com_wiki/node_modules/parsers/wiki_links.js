...
/*
Replaces all article links in article text with hyperlinks
 */
module.exports = function wiki_links(text, article, cb) {

    if (!text){
        return cb(new Error('no text'), '', article);
    }
    ...
    parts.forEach(function (part) {
            ...
            var repl = '<a href="/wiki/a/' + article.scope + '/' + part.name + '" class="wikilink">' + part.label + '</a>';
       do {
